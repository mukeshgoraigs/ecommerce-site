<%@ Page Title="" Language="C#" MasterPageFile="~/UrbanAdmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Shipment.aspx.cs" Inherits="UrbanAdmin_Shipment" %>
            ...
            <div class="input-group">
                ...
                <asp:TextBox runat="server" id="dateto" placeholder="Date To "  type="text" class="t-date-picker form-control" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:Button ID="btnGetInvoice" runat="server" CssClass="btn btn-success" Text="Get Shipped Orders" OnClick="btnGetShipped_Click" />
                                        ...
                                        <div class="panel-body table-responsive">
                                            <table id="example" class="table table-striped table-bordered " cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    <asp:Repeater ID="rpShippedOrder" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
