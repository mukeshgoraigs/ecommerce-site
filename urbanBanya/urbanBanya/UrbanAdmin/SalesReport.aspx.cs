...
public partial class UrbanAdmin_SalesReport : System.Web.UI.Page
{
    ...
    protected void btnGetReport_Click(object sender,EventArgs e)
    {
        ...
        OrderHeaderData ohdata = new OrderHeaderData();
        DataSet ds = ohdata.getOrderHeader("select id,userid,address,ordertotal,placedate,orderdate,ordertime,status from orderheader where isconfirm=1 and status='Completed' and placedate between '" + datef+"' and '"+datet+ "' order by id desc limit 10");
        rpTopOrer.DataSource = ds;
        rpTopOrer.DataBind();
    }
