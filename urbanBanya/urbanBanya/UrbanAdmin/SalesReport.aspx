<%@ Page Title="" Language="C#" MasterPageFile="~/UrbanAdmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="SalesReport.aspx.cs" Inherits="UrbanAdmin_SalesReport" %>
            ...
            <div class="input-group">
                ...
                <asp:TextBox runat="server" id="dateto" placeholder="Date To "  type="text" class="t-date-picker form-control" />
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:Button ID="btnGetReport" runat="server" CssClass="btn btn-success" Text="Get Report" OnClick="btnGetReport_Click" />
                                                    <asp:Button ID="btnExportExcel" runat="server" CssClass="btn btn-warning" Text="Export Excel" ></asp:Button>
                                                </div>
                                            </div>
