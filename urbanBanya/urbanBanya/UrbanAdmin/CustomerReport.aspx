<%@ Page Title="" Language="C#" MasterPageFile="~/UrbanAdmin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CustomerReport.aspx.cs" Inherits="UrbanAdmin_CustomerReport" %>
                                                        ...
                                                        <asp:Repeater ID="rpCustomer" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList Enabled="false" ID="cmbCustomerStatus" DataTextField="status" DataValueField="status" runat="server" CssClass="form-control" AutoPostBack="true">
                                                                            <asp:ListItem Value="0">Block</asp:ListItem>
                                                                            <asp:ListItem Value="1">Active</asp:ListItem>
