<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UrbanBargains.aspx.cs" Inherits="UrbanBargains" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="productListing " style="margin-top:0px">
                    ...
                    <h2>Products in <asp:Label ID="lblSubCatName" Text="Urban Bargains" runat="server"></asp:Label></h2>
                    <div class="clearFix jsProductContainer" data-count="212">

                        <asp:Repeater ID="rpUrbanBargains" runat="server">
                            <ItemTemplate>
